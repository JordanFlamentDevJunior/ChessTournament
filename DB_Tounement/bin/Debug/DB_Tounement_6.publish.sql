...
GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé bf9a652c-8804-4b3a-abf9-37083c750b9f est ignorée, l''élément [dbo].[Genre].[ValueGenre] (SqlSimpleColumn) ne sera pas renommé en ValueGender';


GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé 54c8a616-92fa-4e6b-9259-0abb755c0e8a est ignorée, l''élément [dbo].[Personne].[Id] (SqlSimpleColumn) ne sera pas renommé en Id_Person';


GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé d17f169f-e11f-463d-aa37-f92b2521a9d0 est ignorée, l''élément [dbo].[Place].[Id] (SqlSimpleColumn) ne sera pas renommé en Id_Place';


GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé 59bde7e4-8640-4617-8d15-9949603565fc est ignorée, l''élément [dbo].[Status].[Id] (SqlSimpleColumn) ne sera pas renommé en Id_Status';


GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé 59a86454-d725-4997-bf89-cbb3b859e468 est ignorée, l''élément [dbo].[Historic_Tournament].[Id] (SqlSimpleColumn) ne sera pas renommé en Id_MAJ';


GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé e69976ed-f10d-48b6-9794-a97d27aa6c97 est ignorée, l''élément [dbo].[Tournament].[Id] (SqlSimpleColumn) ne sera pas renommé en Id_Tournament';


GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé d8b07b7a-95b1-4f94-a479-6f62ed855679 est ignorée, l''élément [dbo].[Participation].[Id] (SqlSimpleColumn) ne sera pas renommé en Id_participation';


GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé d6934b1f-7075-43a7-8249-bafe5f92299a, ea465fda-ed3b-45fa-af33-d9c07bc111f5 est ignorée, l''élément [dbo].[Participation].[Date_Inscription] (SqlSimpleColumn) ne sera pas renommé en SubscribDate';


GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé b32eead0-7371-434a-b6b4-e52b771a5c90 est ignorée, l''élément [dbo].[Participation].[Date_] (SqlSimpleColumn) ne sera pas renommé en UnsubscribeDate';


GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé 4d397606-ca2b-4e41-a7d6-0871c72e9911 est ignorée, l''élément [dbo].[meet].[Id] (SqlSimpleColumn) ne sera pas renommé en Id_meting';
...
ALTER TABLE [dbo].[meet] WITH CHECK CHECK CONSTRAINT [FK_meet_Id_P_W];

ALTER TABLE [dbo].[meet] WITH CHECK CHECK CONSTRAINT [FK_meet_Id_P_B];

ALTER TABLE [dbo].[Participation] WITH CHECK CHECK CONSTRAINT [FK_Participation_IdPerson];
...
ALTER TABLE [dbo].[Historic_Tournament] WITH CHECK CHECK CONSTRAINT [CK_Historic_MajDate];

ALTER TABLE [dbo].[Historic_Tournament] WITH CHECK CHECK CONSTRAINT [CK_Historic_Id_Status];

ALTER TABLE [dbo].[meet] WITH CHECK CHECK CONSTRAINT [CK_meet_IdMeet_pos];
...
ALTER TABLE [dbo].[meet] WITH CHECK CHECK CONSTRAINT [CK_meet_Id_W];

ALTER TABLE [dbo].[meet] WITH CHECK CHECK CONSTRAINT [CK_meet_Id_B];

ALTER TABLE [dbo].[meet] WITH CHECK CHECK CONSTRAINT [CK_meet_coherence_player];

ALTER TABLE [dbo].[Participation] WITH CHECK CHECK CONSTRAINT [CK_Participation_IdPart];

ALTER TABLE [dbo].[Participation] WITH CHECK CHECK CONSTRAINT [CK_Participation_IdPerson];

ALTER TABLE [dbo].[Participation] WITH CHECK CHECK CONSTRAINT [CK_Participation_IdTournament];

ALTER TABLE [dbo].[Participation] WITH CHECK CHECK CONSTRAINT [CK_Participation_Subscrib];

ALTER TABLE [dbo].[Participation] WITH CHECK CHECK CONSTRAINT [CK_Participation_Unsubscrib];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_Id];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_Pseudo];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_Mail];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_BirthDatee_Min];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_BirthDate_Max];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_DateRegist_Min];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_DateRegist_Max];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_Password];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_Elo_Min];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_Elo_Max];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_NbrPartPlayed_Min];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_NbrPartWin_Min];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_NbrPartWin_Max];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_NbrPartLost_Min];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_NbrPartLost_Max];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_NbrPartDraw_Min];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_NbrPartDraw_Max];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_Score_Min];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_Score_Max_A];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_Score_Max_B];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [CK_Person_Score_Max_Total];
...
ALTER TABLE [dbo].[Tournament] WITH CHECK CHECK CONSTRAINT [CK_Tournament_Id];
