...
GO
PRINT N'Modification de Procédure [dbo].[AddRole]...';


GO
ALTER PROCEDURE AddRole
    @ValueRole NCHAR(6)
AS
BEGIN
...
END;
GO
PRINT N'Création de Procédure [dbo].[CheckStatNameExists]...';
...
BEGIN
    ...
    BEGIN
        PRINT 'Erreur : Un status avec cet ID ou ce nom existe déjà.';
        RETURN;
    END
END;
GO
PRINT N'Création de Procédure [dbo].[DeleteStatus]...';
...
END;
GO
PRINT N'Création de Procédure [dbo].[AddStatus]...';
